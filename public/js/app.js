...
var _iview = __webpack_require__(2);
...
_vue2.default.component('example-component', __webpack_require__(19));

var router = new _vueRouter2.default({
    routes: [{ path: '/hello', component: __webpack_require__(26) }]
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(22)("59a8a216", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
